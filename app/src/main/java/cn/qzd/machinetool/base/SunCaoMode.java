...
public class SunCaoMode {
    ...
    public double cutThick;//锯片厚度

    public double GrooveWidth ;//槽宽--> 槽长
    public double GrooveDeep ;//槽深
    public double GrooveThick ;//槽厚--> 槽宽

    public String grooveType;//榫槽类型 全开口: 1; 半开口方形闭合:2; 半开口圆形闭合:3;//新加
    public double zSafeDist;//Z安全距离
    public double leftMargin ;//左边间距
    public double bottomMargin ;//下边间距
    public double cutPercent;//切削百分比
